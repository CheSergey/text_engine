    ...
    while True:
        ...
        if translation_menu_choice == 1:
            ...
            if output_file_name.endswith(".docx"):
                document = export_document_format(translated_chunks)
...
def export_document_format(translated_chunks):
    ...
    for paragraph in paragraphs_modified:
        ...
        doc_paragraph.paragraph_format.space_before = docx.shared.Pt(0)
        doc_paragraph.paragraph_format.space_after = docx.shared.Pt(0)
        doc_paragraph.paragraph_format.line_spacing = 1.15
        if doc_paragraph.runs:
            text_part = doc_paragraph.runs[0]
            text_part.font.name = "Times New Roman"
            text_part.font.size = docx.shared.Pt(12)
    return document
